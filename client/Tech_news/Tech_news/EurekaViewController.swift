...
class EurekaViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //jsonパース
        let url:String =  address + "/api/articles/?company=eureka"
